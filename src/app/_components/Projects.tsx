...
const FrameworksDropdown = ({ frameworks }: FrameworksDropdownProps): ReactElement | undefined => {
  if (frameworks && frameworks.length > 0) {
    ...
    return (
      <div className="group flex h-4 w-11/12 flex-col items-center justify-between rounded-b-md bg-primary/90 shadow-sm shadow-primary transition-all duration-1000 hover:h-[20rem] lg:hover:h-[23rem]">
        <div className="flex h-full w-full justify-between overflow-y-auto px-4 py-6 opacity-0 transition-opacity duration-700 ease-in scrollbar-none group-hover:opacity-100 sm:px-8 md:px-14 2xl:px-20">
